...
public class Menu extends javax.swing.JFrame {
    ...
    public Menu() {
        // Constructor
        initComponents(); //buat ngeload komponen yang didesain //method default
        listMhs = new ArrayList<>();
        
        // Dummy
        listMhs.add(new Mahasiswa("2132888", "Na Jaemin", "A", "Laki-laki"));
        listMhs.add(new Mahasiswa("2001103", "Melfray Simbolon", "B", "Perempuan"));
        listMhs.add(new Mahasiswa("2202222", "Nicholas Kevin", "C", "Laki-laki"));        
        ...
        // Set Gender Dropdown
        fieldGender.setModel(new DefaultComboBoxModel<>(genderOptions));
    }
    ...
    public void insertData() {
        ...
        String gender = (String) fieldGender.getSelectedItem();
        
        // Validasi Form
        if (nim.equals("")) {
            // Show Error Message
            JOptionPane.showMessageDialog(null, "Mohon isi NIM yang ingin ditambahkan.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        } else if (nama.equals("")) {
            // Show Error Message
            JOptionPane.showMessageDialog(null, "Mohon isi Nama yang ingin ditambahkan.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        } else if (nilai.equals("")) {
            // Show Error Message
            JOptionPane.showMessageDialog(null, "Mohon isi Nilai yang ingin ditambahkan.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void initComponents() {
        ...
        fieldGender.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        // TODO add your handling code here:
        // Menampilkan pop-up confirmation prompt
        ...
        // Jika pilihan "Yes" maka data dihapus
        if(isUpdate == true && confirm == JOptionPane.YES_OPTION){
            deleteData();
            btnAdd.setText("Add");
            btnDelete.setVisible(false);
            this.isUpdate = false;
        ...
        // Jika pilihan "No" maka tidak terjadi apapun
